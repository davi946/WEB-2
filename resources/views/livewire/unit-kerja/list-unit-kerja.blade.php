            ...
            <tbody>
                @foreach ($unitKerjas as $index => $unit)
                    <tr class="{{ $index % 2 === 0 ? 'bg-gray-900' : 'bg-gray-800' }} text-white">
                        <td class="py-2 px-4 border border-white-700">{{ $unit->id }}</td>
                        <td class="py-2 px-4 border border-white-700">{{ $unit->kode }}</td>
                        <td class="py-2 px-4 border border-white-700">{{ $unit->nama }}</td>
